...
let loadWeekForecastData = () => {
    ...
    for (let item of data) {
        for(let idx of item.forecast_week){
            let { day, text, date, temperature, icon } = idx;
            ...
            let weekforecast_gye = document.getElementsByClassName("list-group");
            weekforecast_gye[0].innerHTML = week_data    
...
let drop_id = document.getElementById('loadinfo');

drop_id.addEventListener('click', () => {
